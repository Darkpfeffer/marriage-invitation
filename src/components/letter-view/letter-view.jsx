    ...
    return (
        <div className="letter">
            ...
            <p className="letter-text">
                ...
                kívánja tölteni, így megkérte a kezét.<br/>
                ...
                esküvőnk életre szóló emlékét.<br/>
                ...
                <br/>
                Szeretettel:<br/>
                A Menyasszonytól és a Vőlegénytől</p>
        </div>
    )
}
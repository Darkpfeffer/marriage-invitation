...
export const AboutUsView = () => {
    return (
        <div className="about-us-content">
            ...
            <h1 className="about-us__title"><span className="about-us__title--capital">K</span>incső és Zoltán története</h1>
            <p>
            ...
            <p>
                <span className="about-us__year">2020</span> márciusában, mikor kirobbant a világjárvány, távoktatást vette kezdetét, úgyhogy újra egy fedél alatt élhettünk. Nem sokkal később, első évfordulónkon, megvettük második közös kiskedvencünket is, egy tengerimalacot, akit Morzsának vagy Milimalinak szólítottunk. A nyáron még egy kis utazást is sikerült beiktatunk, Amszterdamba látogattunk, és a Balatonon üdültünk. Aztán újra eljött az ősz, és mivel csitult a járvány, hibrid oktatás vette kezdetét, ami azt jelentette, Kincső újra elment Budapestre tanulni, és a legnehezebb hónapok köszöntöttek ránk, mert egyáltalán nem tudtunk találkozni a karanténszabályok miatt. Ezek a hónapok arra tanítottak minket, értékeljük azt is, ami olyan természetesnek tűnik: hogy az ember együtt él szerelmével, találkozhat vele nap mint nap, és egy utazás vége nem jelenti az együtt töltött idő végét is.
            </p>
            <p>
                <span className="about-us__year">2021</span> év elején a távkapcsolatok korszaka számunkra véget ért, egyszer és mindenkorra, mivel visszavezették a távoktatást. Február 4-én családunk bővült, kutyánk, Leszter megvételével. A kölyökkora sok kihívást tartogatott, igencsak felforgatta életünket, de mára már egy kedves kutyus lett. A nyáron beiktattunk egy kis tengerparti pihenést, Görögországba, Míknosz szigetére repültünk, ez volt Zoli élete első repülőútja.
            </p>
            <p>
            ...
            <h6 className="about-us__thanks">Köszönünk minden kis és nagy segítséget idáig vezető utunkon és az esküvőszervezésben! </h6>
        </div>
    )
}